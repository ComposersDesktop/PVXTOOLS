...
public:
    ...
    bool init(int outsrate,int fftlen,int winlen,int decfac,float scalefac,
    ...
    bool init(int outsrate,int fftlen,pvoc_overlapfac ofac,float scalefac,
                        pvoc_scaletype stype,pvoc_windowtype wtype,pvocmode mode);
    ...
    int syn_interp(void)   { 
                    if(P != 1.0f) 
                        ...
                        return I;}
    int fftlen(void)  {return N;}
    int winlen(void) { return M;}
